...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Project.Domain.Entities.StageEvent", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<TimeSpan?>("DurationInPreviousState")
                    ...
                    b.Property<int?>("PreviousMachineId")
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("NewMachineId");

                    b.HasIndex("OperatorId");

                    b.HasIndex("PreviousMachineId");

                    b.HasIndex("StageExecutionId");

                    b.HasIndex("EventTimeUtc", "EventType");

                    b.ToTable("StageEvents");
                });
            ...
            modelBuilder.Entity("Project.Domain.Entities.SystemEvent", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<DateTime?>("NextProcessingAttempt")
                        .HasColumnType("timestamp with time zone");
                    ...
                    b.HasIndex("IsProcessed", "Severity");

                    b.HasIndex("EventTimeUtc", "Category", "Severity");
            ...
            modelBuilder.Entity("Project.Domain.Entities.StageEvent", b =>
                {
                    b.HasOne("Project.Domain.Entities.Machine", "NewMachine")
                        .WithMany()
                        .HasForeignKey("NewMachineId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("Project.Domain.Entities.Machine", "PreviousMachine")
                        .WithMany()
                        .HasForeignKey("PreviousMachineId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("Project.Domain.Entities.StageExecution", "StageExecution")
                        .WithMany()
                        .HasForeignKey("StageExecutionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("NewMachine");

                    b.Navigation("PreviousMachine");
